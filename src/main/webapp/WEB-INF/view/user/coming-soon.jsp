...
<body>
	...
	<div
		class="container py-5 osahan-coming-soon d-flex justify-content-center align-items-center">
		<div class="osahan-img text-center">
			<svg xmlns="http://www.w3.org/2000/svg"
				id="bfad9f77-0abd-4173-8308-819d02b95b56" data-name="Layer 1"
				viewBox="0 0 722.78214 670.02319"
				class="injected-svg modal__media modal__lg_media mb-5 w-300 mx-auto"
               ...
               <ellipse cx="358" cy="646.02319" rx="358" ry="24"
					fill="#3f3d56"></ellipse>
               <rect x="352" y="384.02319" width="12" height="7"
					fill="#3f3d56"></rect>
               <rect x="376" y="384.02319" width="12" height="7"
					fill="#3f3d56"></rect>
               <rect x="400" y="384.02319" width="12" height="7"
					fill="#3f3d56"></rect>
               <rect x="424" y="384.02319" width="12" height="7"
					fill="#3f3d56"></rect>
               <rect x="448" y="384.02319" width="12" height="7"
					fill="#3f3d56"></rect>
               <rect x="472" y="384.02319" width="12" height="7"
					fill="#3f3d56"></rect>
               <rect x="496" y="384.02319" width="12" height="7"
					fill="#3f3d56"></rect>
               <rect x="520" y="384.02319" width="12" height="7"
					fill="#3f3d56"></rect>
               <rect x="544" y="384.02319" width="12" height="7"
					fill="#3f3d56"></rect>
               <rect x="568" y="384.02319" width="12" height="7"
					fill="#3f3d56"></rect>
               <rect x="592" y="384.02319" width="12" height="7"
					fill="#3f3d56"></rect>
               <path d="M870.10893,503.5116a144,144,0,1,1-288,0Z"
               ...
               <polygon
					...
					fill="#3f3d56"></polygon>
               <rect x="414" y="569.02319" width="148" height="10"
					fill="#3f3d56"></rect>
               <path
               ...
               <path
					...
					transform="translate(-238.60893 -114.9884)" fill="#2f2e41"></path>
               <circle cx="207.28302" cy="43.79674" r="36.00404"
					fill="#ffb9b9"></circle>
               <polygon
			...
			<div class="osahan-text text-center mt-3">
				<h2 class="text-primary font-weight-light">
					We're coming <span class="font-weight-bold">soon.</span>
				</h2>
				<p class="lead small mb-5">Our website is under construction.
	...
	<script type="abd0d7c2f2cf58111fabf6ee-text/javascript"
	...
	<script
		...
		data-cf-settings="abd0d7c2f2cf58111fabf6ee-|49" defer=""></script>
</body>
</html>