...
<body>
	...
	<div
		...
		<div class="osahan-img">
			...
			<div class="osahan-text text-center mt-3">
				...
				<p class="lead small mb-5">We apologize for the inconvenience
					but Front is currently undergoing planned maintenance.</p>
				<a href="home.jsp" class="btn btn-primary"> Check for Updates </a> <a
					href="#" class="btn btn-light"> Buy Now </a>
			</div>
		</div>
	</div>
	...
	<script type="9310a65d7470c7b2df8e7348-text/javascript"
	...
	<script
		...
		data-cf-settings="9310a65d7470c7b2df8e7348-|49" defer=""></script>
</body>
</html>