...
<body>
	...
	<div
		...
		<div class="osahan-text text-center">
			...
			<p class="lead small mb-0">Oops! Looks like you followed a bad
				link.</p>
			<p class="mb-5">
				If you think this is a problem with us, please <a href="#">tell
					us</a>.
			</p>
			<a href="home.jsp" class="btn btn-primary">Go Back</a> <a
				href="faq.jsp" class="btn btn-light">Help</a>
		</div>
	</div>
