...
<body class="fixed-bottom-bar">
	...
	<div class="offer-section py-4">
		<div class="container position-relative">
			<img alt="#" src="userResources/image/trending1.png"
			...
			<div class="pt-3 text-white">
				...
				<div class="rating-wrap d-flex align-items-center mt-2">
					<ul class="rating-stars list-unstyled">
						<li><i class="feather-star text-warning"></i> <i
		...
		<div class="p-3 bg-primary bg-primary mt-n3 rounded position-relative">
			<div class="d-flex align-items-center">
				...
				<a href="contact-us.jsp"
					class="btn btn-sm btn-outline-light ml-auto">Contact</a>
			</div>
		</div>
	</div>
	<div class="container">
					...
					<div
						...
						<div class="p-3 position-relative">
							<div class="list-card-body">
								<h6 class="mb-1">
									<a href="checkout.jsp" class="text-black">Famous Dave's
										Bar-B-Que</a>
								</h6>
				...
				<div class="osahan-slider-item">
					<div
						...
						<div class="p-3 position-relative">
							<div class="list-card-body">
								<h6 class="mb-1">
									<a href="checkout.jsp" class="text-black">Thai Famous
										Cuisine</a>
								</h6>
				...
				<div class="osahan-slider-item">
					<div
						...
						<div class="p-3 position-relative">
							<div class="list-card-body">
								<h6 class="mb-1">
									<a href="checkout.jsp" class="text-black">The osahan
										Restaurant</a>
								</h6>
		...
		<div class="row">
			<div class="col-md-8 pt-3">
							...
							<div class="">
								...
								<div class="p-3 border-bottom gold-members">
									...
									<div class="media">
										...
										<div class="media-body">
											<h6 class="mb-1">
												Cheese corn Roll <span class="badge badge-danger">BEST
													SELLER</span>
											</h6>
								...
								<div class="p-3 border-bottom gold-members">
									...
									<div class="media">
										...
										<div class="media-body">
											<h6 class="mb-1">
												Chicken Tikka Sub <span
													class="badge badge-danger text-white">Non veg</span>
											</h6>
											<p class="text-muted mb-0">$250</p>
										</div>
									</div>
							...
							<div class="">
								<div class="p-3 border-bottom menu-list">
									<span class="float-right"><a href="#"
										...
										data-target="#extras">ADD</a></span>
									<div class="media">
										<img alt="#" src="userResources/image/starter1.jpg"
											alt="askbootstrap" class="mr-3 rounded-pill ">
										<div class="media-body">
											<h6 class="mb-1">Chicken Tikka Sub</h6>
											<p class="text-muted mb-0">$250</p>
										</div>
								...
								<div class="p-3 border-bottom menu-list">
									<span class="float-right"><a href="#"
										...
										data-target="#extras">ADD</a></span>
									<div class="media">
										<img alt="#" src="userResources/image/starter2.jpg"
											alt="askbootstrap" class="mr-3 rounded-pill ">
										<div class="media-body">
											<h6 class="mb-1">
												Cheese corn Roll <span class="badge badge-danger">BEST
								...
								<div class="p-3 border-bottom menu-list">
									<span class="float-right"><a href="#"
										...
										data-target="#extras">ADD</a></span>
									<div class="media">
										<img alt="#" src="userResources/image/starter3.jpg"
											alt="askbootstrap" class="mr-3 rounded-pill ">
										<div class="media-body">
											<h6 class="mb-1">
												Chicken Tikka Sub <span class="badge badge-success">Pure
													Veg</span>
											</h6>
											<p class="text-muted mb-0">$250</p>
										</div>
				...
				<div class="mb-3">
					...
					<div
						class="bg-white rounded p-3 mb-3 clearfix graph-star-rating rounded shadow-sm">
						...
						<div class="graph-star-rating-body">
							...
							<div class="rating-list">
								<div class="rating-list-left font-weight-bold small">4
									Star</div>
								<div class="rating-list-center">
									<div class="progress">
										<div role="progressbar" class="progress-bar bg-info"
					...
					<div
						...
						<div class="reviews-members py-3">
							<div class="media">
								<a href="#"><img alt="#"
									src="userResources/image/reviewer1.png"
								...
								<div class="media-body">
									...
									<div class="reviews-members-footer">
										<a class="total-like btn btn-sm btn-outline-primary" href="#"><i
											class="feather-thumbs-up"></i> 856M</a> <a
											class="total-like btn btn-sm btn-outline-primary" href="#"><i
											class="feather-thumbs-down"></i> 158K</a> <span
											class="total-like-user-main ml-2" dir="rtl"> <a
											href="#" aria-describedby="tooltip-top0"><img alt="#"
												src="userResources/image/reviewer3.png"
												class="total-like-user rounded-pill"></a> <a href="#"
											aria-describedby="tooltip-top1"><img alt="#"
												src="userResources/image/reviewer4.png"
												class="total-like-user rounded-pill"></a> <a href="#"><img
												alt="#" src="userResources/image/reviewer5.png"
												class="total-like-user rounded-pill"></a> <a href="#"
											aria-describedby="tooltip-top3"><img alt="#"
												src="userResources/image/reviewer6.png"
						...
						<div class="reviews-members py-3">
							<div class="media">
								<a href="#"><img alt="#"
									src="userResources/image/reviewer2.png"
									class="mr-3 rounded-pill"></a>
								<div class="media-body">
									<div class="reviews-members-header">
										<div class="star-rating float-right">
									...
									<div class="reviews-members-footer">
										<a class="total-like btn btn-sm btn-outline-primary" href="#"><i
											...
											href="#"><img alt="#"
												src="userResources/image/reviewer3.png"
												class="total-like-user rounded-pill"></a><a href="#"><img
												alt="#" src="userResources/image/reviewer4.png"
												class="total-like-user rounded-pill"></a><a href="#"><img
												alt="#" src="userResources/image/reviewer5.png"
												class="total-like-user rounded-pill"></a><a href="#"><img
												alt="#" src="userResources/image/reviewer6.png"
					...
					<div
						class="bg-white p-3 rating-review-select-page rounded shadow-sm">
			...
			<div class="col-md-4 pt-3">
				<div
					...
					<div
						...
						<img alt="osahan" src="userResources/image/starter1.jpg"
							class="mr-3 rounded-circle img-fluid">
						<div class="d-flex flex-column">
							<h6 class="mb-1 font-weight-bold">Spice Hut Indian
								Restaurant</h6>
					...
					<div class="bg-white border-bottom py-2">
						<div
							...
							<div class="d-flex align-items-center">
								<span class="count-number float-right"><button
										type="button"
					...
					<div class="p-3">
						<a class="btn btn-success btn-block btn-lg" href="successful.jsp">PAY
							$1329<i class="feather-arrow-right"></i>
						</a>
					</div>
				</div>
			</div>
