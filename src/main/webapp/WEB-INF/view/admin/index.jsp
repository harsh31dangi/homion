...
<head>
  ...
  <link rel="stylesheet" href="adminResources/css/bootstrap-datepicker.min.css">
...
<body class="sidebar-light">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="d-flex border-bottom pb-3">
                    <img src="adminResources/image/face1.jpg" alt="profile" class="img-xs rounded-circle"/>
                  ...
                  <div class="d-flex border-bottom py-3">
                    <img src="adminResources/image/face2.jpg" alt="profile" class="img-xs rounded-circle"/>
                    <div class="flex-grow-1 ml-3">
                      <p>Lillie Long</p>
                      <div class="d-flex text-muted">
                  ...
                  <div class="d-flex border-bottom py-3">
                    <img src="adminResources/image/face3.jpg" alt="profile" class="img-xs rounded-circle"/>
                    <div class="flex-grow-1 ml-3">
                      <p>Lloyd Harper</p>
                      <div class="d-flex text-muted">
                  ...
                  <div class="d-flex pt-3">
                    <img src="adminResources/image/face4.jpg" alt="profile" class="img-xs rounded-circle"/>
                    <div class="flex-grow-1 ml-3">
                      <p>Bradley Foster</p>
                      <div class="d-flex text-muted">
  ...
  <script src="adminResources/js/bootstrap-datepicker.min.js"></script>
